    ...
    <div style={{ width: '100%', height: '100vh', display: 'flex' }}>
      ...
      <FlowCanvas
        ...
        story={activeDemo === 'showcase' ? {
          ...
          steps: [
            { nodeId: 'mains', title: '1. AC Mains Input', duration: 10000, content: 'Power enters through an **IEC C14** connector. The supply accepts **85-264V AC** universal input, making it compatible worldwide.' },
            ...
            { nodeId: 'half-bridge', title: '7. Half-Bridge LLC Converter', duration: 12000, content: 'Two MOSFETs (Q2/Q3) form a **half-bridge** that drives the LLC resonant tank. This topology achieves **zero-voltage switching (ZVS)** across the full load range, maximizing efficiency.' },
            { nodeId: 'hf-xfmr', title: '8. High-Frequency Transformer', duration: 12000, content: 'The transformer operates at **100-300 kHz**, enabling a compact design. It provides **galvanic isolation** between the dangerous mains voltage and the safe output side. Multiple secondary windings produce the +12V and +5V rails.' },
